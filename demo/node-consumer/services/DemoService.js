...
exports.ServiceHead = {
    ...
    methods: {
        ...
        sayHello2: function(req) {
            return [{ $class: "com.alibaba.dubbo.demo.DemoReq", $: req }];
        },
        sayHello3: function(name, age) {
            return [
...
function sayHello3(name, age) {
    return dubbo_node_zookeeper_1.default.exec(
        "DemoService.sayHello3",
        name,
        age
    );
}
