...
var ServiceImpl = /** @class */ (function () {
        ...
        this.find = function (path, cb) {
            ...
            _this.zookeeper.getChildren("/" + _this.root + "/" + path + "/providers", _this.find.bind(path), function (err, children) {
                ...
                for (var i = 0, l = children.length; i < l; i++) {
                    zoo = querystring_1.default.parse(decodeURIComponent(children[i]));
    ...
    ServiceImpl.prototype.execute = function (method, args) {
        var _this = this;
        this.encodeParam._method = method;
        this.encodeParam._args = args;
        var buffer = new encode_1.Encode(this.encodeParam);
